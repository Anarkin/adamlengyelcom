...
- Keep the site fully self-contained: no CDNs, no external requests. The JetBrains Mono NL font (the no-ligatures build) is self-hosted in `src/resources/` (Regular only, Latin subset woff2, OFL-licensed).
